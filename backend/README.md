...
## Project Structure
    ...
    ├── wandering_mouse_dev_67761  # Django project configurations
...
1. Clone this repo and `cd wandering_mouse_dev_67761`
...
2. Clone this repo and `cd wandering_mouse_dev_67761`
